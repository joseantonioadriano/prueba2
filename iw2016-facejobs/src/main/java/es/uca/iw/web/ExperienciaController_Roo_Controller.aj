...
privileged aspect ExperienciaController_Roo_Controller {
    ...
    void ExperienciaController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("experiencia_fecini_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
        uiModel.addAttribute("experiencia_fecfin_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
